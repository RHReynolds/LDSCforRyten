...
arguments <- parse_args(OptionParser(usage = "%prog",
                                     ...
                                     option_list=list(
                                       ...
                                       make_option(c("-b","--baseline_model"), default = "97", help = "If a different baseline is desired for estimation of heritability, call this flag. Choose between: 53, 75, 76, 86 or 97. [default: 97]"),
